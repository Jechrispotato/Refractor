...
## Figure 3A: Main Interface for Super Administrator — Part 1: Authentication
```mermaid
flowchart TD
...
## Figure 3B: Main Interface for Super Administrator — Part 2: Core Management
```mermaid
flowchart TD
...
## Figure 3C: Main Interface for Super Administrator — Part 3: Admin Tools
```mermaid
flowchart TD
...
## Figure 4A: Main Interface for LGU Administrator — Part 1: Authentication
```mermaid
flowchart TD
    Start([Start]) --> Login[/Enter Email and Password/]
    Login --> Auth{Authenticated?}
...
## Figure 4B: Main Interface for LGU Administrator — Part 2: Core Operations
```mermaid
flowchart TD
...
## Figure 4C: Main Interface for LGU Administrator — Part 3: Admin Functions
```mermaid
flowchart TD
...
## Figure 11A: User Management — Part 1: Access and Filter
```mermaid
flowchart TD
...
## Figure 11B: User Management — Part 2: User Actions
```mermaid
flowchart TD
...
## Figure 11C: User Management — Part 3: Reporting
```mermaid
flowchart TD
...
## Figure 12A: Main Interface for Citizen — Part 1: Authentication
```mermaid
flowchart TD
...
## Figure 12B: Main Interface for Citizen — Part 2: Core Services
```mermaid
flowchart TD
...
## Figure 12C: Main Interface for Citizen — Part 3: Account Options
```mermaid
flowchart TD
